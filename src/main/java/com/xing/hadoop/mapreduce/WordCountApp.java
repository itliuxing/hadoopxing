 ...
 * @Direction 类说明       使用MapReduce开发wordcount应用程序
 *
 * Hadoop处理命令：
 *      hadoop jar /usr/hadoop/data/hadoopxing-1.0-SNAPSHOT.jar com.xing.hadoop.mapreduce.WordCountApp hdfs://hadoop000:8020/hdfsapi/hello.txt hdfs://hadoop000:8020/hdfsapi/output/wc
 */
